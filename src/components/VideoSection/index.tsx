...
const Footer: NextPage = () => {
  ...
  return (
    <>
      ...
      <section className="section is-medium is-mobile">
        <div className="columns is-vcentered is-mobile is-centered">
          ...
          <div className="column is-8 has-padding-left-90">
            ...
            <p data-aos="fade-left" className="subtitle is-size-4">Explore ao máximo nossa plataforma para conseguir se destacar entre as empresas ou candidatos.</p>
